...
func TestMagneticConstantFormat(t *testing.T) {
	for _, test := range []struct {
		...
		{"%v", "1.2566370823307871e-06 A^2 s^4 kg^-1 m^-3"},
		{"%.1v", "1e-06 A^2 s^4 kg^-1 m^-3"},
		{"%50.1v", "                          1e-06 A^2 s^4 kg^-1 m^-3"},
		{"%50v", "         1.2566370823307871e-06 A^2 s^4 kg^-1 m^-3"},
		{"%1v", "1.2566370823307871e-06 A^2 s^4 kg^-1 m^-3"},
		{"%#v", "constant.magneticConstantUnits(1.2566370823307871e-06)"},
		{"%s", "%!s(constant.magneticConstantUnits=1.2566370823307871e-06 A^2 s^4 kg^-1 m^-3)"},
	} {
